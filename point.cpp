...
void point::print(const int colorName, const int colorN) const//in ra man hinh cho dep voi hai mau da chon, mot mau ten thu gi do, mot mau gia tri so thu gi do
{
