...
string startGame()
{
    Word menuGame[] =
    {
        ...
        {"2. Choi luon", {20, 6}},
        {"3. Huong dan", {20, 7}},
        {"Chon cai ban thich: ", {20, 8}}
    };
    int nMenu = sizeof(menuGame) / sizeof(Word), tSleep = 400;
    ...
    Word wordWarning = {"Nhap lai: ", {20, 9}};
    cin >> playerDecision;
    ...
    {
        case 1:  return "Khong choi";
        case 2: return "Choi luon";
        case 3: return "Huong dan";
    }
}
void introduce()//gioi thieu ten va luat choi
{
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE) , default_ColorCode);//chuyen ve mau trang
    int tSleep = 100;
    //gioi thieu ten tro choi
    Word nameGame = {"TEST ENGLISH", {34, 8}};
    //hieu ung lam in ra tung chu cua ten tro choi ra man hinh
    for(int i = 0;i < nameGame.s.length();i ++)
        {
